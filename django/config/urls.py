...
urlpatterns = [
    ...
    path("guest-location/set", page_views.set_guest_location, name="set_guest_location"),
    path("guest-location/clear", page_views.clear_guest_location, name="clear_guest_location"),
